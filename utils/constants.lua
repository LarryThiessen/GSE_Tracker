...
-- Center Marker size: the options slider shows this as a PERCENT (100% = 38px). MIN lowered to 9 so the
-- slider's 25% (9.5px) isn't clamped away; MAX 128 covers 200% (76px) with room to spare. Default 38 = 100%.
C.COMBAT_MARKER_MIN_SIZE = 9
C.COMBAT_MARKER_MAX_SIZE = 128
C.COMBAT_MARKER_DEFAULT_SIZE = 38
